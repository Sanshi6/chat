...
API_KEY = "ap-NZTZ3U4Ku8x5clpVfoVdgePQfduZAuWR1fBUUXhvWtA9emTw"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey1,fkxxxx-api2dkey2"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "socks5h://127.0.0.1:20022",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "socks5h://127.0.0.1:20022",  # 再例如  "https": "http://127.0.0.1:7890",
    }
else:
    proxies = None
...
API_URL_REDIRECT: dict[str, str] = {"https://api.openai.com/v1/chat/completions": "https://api.aiproxy.io/v1/chat/completions"}
